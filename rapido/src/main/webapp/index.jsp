        ...
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            <div class="card shadow-lg border-0 rounded-4" style="width: 100%; max-width: 500px;">
                ...
                <div class="card-body p-4 bg-light">
                    ...
                    <h6 style="color:red">${existData}</h6>

                    <div class="card-footer text-center bg-white border-0">
                        <small class="text-muted">
                            If you want to all users details? click here... <a href="fetchData"
                    ...
                    <form action="register" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control border-warning" name="age"
                                placeholder="Enter your age" min="1" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border-warning" name="vehical"
                                placeholder="Enter your vehicle name" required>
                        </div>
